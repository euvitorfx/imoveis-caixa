    ...
    items: [
      {
        ...
        chips: ["Resend", "GitHub Action agendada", "Preferências por estado/cidade"],
      ...
      },
      {
        ...
        desc: "Gmail mobile dark mode ignora bgcolor e media queries do template de boas-vindas, exibindo cores distorcidas. Tentativas com data-ogsc, color-scheme e dark mode nativo não resolveram. Investigar uso de imagens para áreas críticas de cor ou serviço de preview como Litmus.",
        chips: ["Gmail dark mode", "Resend", "Litmus / Email on Acid"],
        dep: "Boas-vindas funcionando em light mode ✓",
      },
    ],
  },
  {
